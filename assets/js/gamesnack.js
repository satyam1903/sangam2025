            ...
            return (
              (t.validateOrReturnError = function (e, t) {
                ...
                return !0 !== n
                  ...
                  : f.instance.validateOrReturnError(e.value, t);
              }),
              t
            );
          }
        ...
        function e(e) {
          ...
          (this.environment = "production"),
            ...
            (this.gameOver = function () {
              t.postMessageHandler.send({ type: "gameOver", value: !0 });
            }),
            ...
            (this._initializeAdsWithValidatedConfig = function (e) {
              if (
                (t._logIfVerbose(
                  "initialize AdSense with config " + JSON.stringify(e, null, 2)
                ),
                !t.adsInitialized)
              ) {
                t.adsInitialized = !0;
                ...
                n.setAttribute("src", a),
                  ...
                  e.dataAdmobAdsOnly &&
                    n.setAttribute("data-admob-ads-only", "on"),
                  ...
                  "on" === e.dataAdbreakTest &&
                    n.setAttribute("data-adbreak-test", "on"),
            ...
            (this._adBreakDone = function (e) {
              t._logIfVerbose(
                "adbreakDone called with placementInfo: " + JSON.stringify(e)
              ),
                t.postMessageHandler.send({
            ...
            (this._subscribeToGhostData = function (e) {
              ...
              window.addEventListener(
                ...
                function (e) {
                  e &&
                    e.data &&
                    "GAMESNACKS_RECEIVE_GHOST_DATA" === e.data.type &&
